...
var getFilteredData = function (data, required_currency) {
    var filtered = {};
    for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
        var currencyData = data_1[_i];
...
module.exports = new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
    var error_1, filtered;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios.get("https://api.coinstats.app/public/v1/coins?skip=0&limit=25&currency=USD")];
            case 1:
                response = _a.sent();
                return [3 /*break*/, 3];
            case 2:
            ...
            case 3:
                if (response) {
                    filtered = getFilteredData(response.data.coins, constants_1.POPULAR_CURRENCY);
                    resolve(filtered);
                }
                return [2 /*return*/];
        }
